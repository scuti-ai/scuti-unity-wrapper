...
namespace Vuplex.WebView {
    ...
    #region Non-public members
        ...
        protected virtual void InputDetector_PointerUp(object sender, PointerEventArgs eventArgs) {
            ...
            if (DragMode == DragMode.DragToScroll && !_dragToScrollClickIsPending) {
            ...
            // Note: when clickWithoutStealingFocus is enabled, use Click() because PointerDown() and PointerUp() don't support the preventStealingFocus parameter.
            ...
            Clicked?.Invoke(this, new ClickedEventArgs(pointerUpPoint));
        }
