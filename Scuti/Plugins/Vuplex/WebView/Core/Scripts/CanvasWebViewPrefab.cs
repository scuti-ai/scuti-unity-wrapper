...
namespace Vuplex.WebView {
    ...
    #region Non-public members
        ...
        float _getScreenSpaceScaleFactor() {
            ...
            // Apply scaling to account for an issue where GetWorldCorners() is incorrect in the following scenarios:
            ...
            var screenResolutionChanged = display.renderingWidth != display.systemWidth && display.systemWidth != Screen.currentResolution.width;
